...
function world() {
  ...
  for (var i = 0; i < locations.length; i++) {
    ...
    marker.bindPopup("<h7><b>View stories from: </b></h7>" +
                      // "<br><h6>""</h6></br>" +
                      "<a id=\"icon-"+locations[i][0]+"\" onclick=\"getStories("+locations[i][0]+")\" href=\"#modal"+locations[i][0]+"\">"+locations[i][0]+"</a>", {maxWidth: 320, closeButton: true});
  }//href=\"#modal"+locations[i][0]+"\"
